...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnCrear; // Se crea la variable de tipo boton
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCrear = findViewById(R.id.btnGuardar); //Configuramos el boton para crear el archivo de Db

        btnCrear.setOnClickListener(new View.OnClickListener() { //Metodo para ejecutar el boton de crear Db
            @Override
            public void onClick(View view) {
                DbHelper dbHelper = new DbHelper(MainActivity.this); //Se crea instancia de un nuevo objeto
                SQLiteDatabase db = dbHelper.getWritableDatabase();

                if(db != null){ //Valida la condicion si el archivo fue creado correctamente o por el contrario no se creo.
    ...
    public void calcularPromedio (View view ){ //Metodo par calcular promedio y conversion de valores a Double.
        ...
        if (Promedio >= 3.0 ){ // Condicional el cual permit saber si el estudianete aprueba o no.
